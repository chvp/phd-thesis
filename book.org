...
The actual assignment also needs to be passed on, but depending on its size this might also present a problem given token limitations of some models.
...
- Fairness/integrity of evaluations in general
    - Improvements to submission process when in evaluation
    - Generative AI
    - Integration of similarity checking (Dolos)
